...
defined('PRIVATEPMTHREADLIMIT_ERROR') or define('PRIVATEPMTHREADLIMIT_ERROR', -1);
defined('PMFLOODCTRL_ERROR') or define('PMFLOODCTRL_ERROR', -2);
defined('PMMSGTONOTFRIEND') or define('PMMSGTONOTFRIEND', -3);
defined('PMSENDREGDAYS') or define('PMSENDREGDAYS', -4);
defined('CHATPMTHREADLIMIT_ERROR') or define('CHATPMTHREADLIMIT_ERROR', -5);
defined('CHATPMMEMBERLIMIT_ERROR') or define('CHATPMMEMBERLIMIT_ERROR', -7);
