...
defined('PMINBALCKLIST_ERROR') or define('PMINBALCKLIST_ERROR', -6);
defined('PMSENDSELF_ERROR') or define('PMSENDSELF_ERROR', -8);
defined('PMSENDNONE_ERROR') or define('PMSENDNONE_ERROR', -9);
defined('PMSENDCHATNUM_ERROR') or define('PMSENDCHATNUM_ERROR', -10);
defined('PMTHREADNONE_ERROR') or define('PMTHREADNONE_ERROR', -11);
defined('PMPRIVILEGENONE_ERROR') or define('PMPRIVILEGENONE_ERROR', -12);
defined('PMCHATTYPE_ERROR') or define('PMCHATTYPE_ERROR', -13);
defined('PMUIDTYPE_ERROR') or define('PMUIDTYPE_ERROR', -14);
defined('PMDATA_ERROR') or define('PMDATA_ERROR', -15);
